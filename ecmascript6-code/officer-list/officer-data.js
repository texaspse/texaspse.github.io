...
export const officerData = [
  ...
  },
  {
    ...
    profile: {
      ...
      githubURL: null,
      linkedinURL: null,
      major: 'Physics and Radio-TV-Film',
      year: 'Junior',
      skills: 'Java, Python, C++, Mathematica, MatLab',
      description: 'Anish is a junior Physics and Radio-TV-Film major with a keen interest in 3D simulation and VR technology. He dreams of space, with the intent to work in the aerospace/defense industry, and eventually hopes to find himself on Mars. In addition to PSE, he currently serves as a Power and Systems Engineer for 512 Hyperloop. In his spare time, he competes for the University of Texas Sailing Team and enjoys aviation, making music, and working on random gadgets using Arduinos.',
    }
  },
  {
  ...
  {
    src: 'assets/officer-images/alvin.jpg',
    title: 'Corporate Director',
    subtitle: 'Alvin Nguyen',
    profile: {
      name: 'Alvin Nguyen',
      ...
      major: 'Petroleum Engineering',
      year: 'Junior',
      skills: 'Java, MATLAB, some Python',
  ...
  },
  {
    ...
    profile: {
      name: 'Art Tuazon',
      position: 'Media Director',
      facebookURL: "https://www.facebook.com/art.tuazon.54",
      githubURL: null,
      linkedinURL: null,
      major: 'Chemical Engineering',
      year: 'Freshman',
